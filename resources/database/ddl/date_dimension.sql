...
SELECT TO_CHAR(datum, 'yyyymmdd')::INT AS date_dim_id,
       ...
       CASE
           WHEN EXTRACT(QUARTER FROM datum) = 1 THEN '1Q-'||EXTRACT(YEAR FROM datum)
           WHEN EXTRACT(QUARTER FROM datum) = 2 THEN '2Q-'||EXTRACT(YEAR FROM datum)
           WHEN EXTRACT(QUARTER FROM datum) = 3 THEN '3Q-'||EXTRACT(YEAR FROM datum)
           WHEN EXTRACT(QUARTER FROM datum) = 4 THEN '4Q-'||EXTRACT(YEAR FROM datum)
           END AS quarter_name,
